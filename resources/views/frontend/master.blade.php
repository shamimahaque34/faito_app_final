...
<!-- Mirrored from faito.co.id/en/home by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jan 2024 13:35:32 GMT -->
...
<head>
    ...
    <link rel="icon" href="../contents/Y1nunJilpj.png">
    ...
    <script type="text/javascript" src="../fe/js/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="../fe/js/TweenMax.min.js"></script>
    <script type="text/javascript" src="../fe/js/select2.full.min.js"></script>
    <script type="text/javascript" src="../fe/js/slick.min.js"></script>

    <script type="text/javascript" src="../fe/js/main.min.js"></script>
    ...
    <!-- Global site tag (gtag.js) - Google Analytics --><script async src="https://www.googletagmanager.com/gtag/js?id=G-P8DTNYZ7MJ"></script><script>  window.dataLayer = window.dataLayer || [];  function gtag(){dataLayer.push(arguments);}  gtag('js', new Date());   gtag('config', 'G-P8DTNYZ7MJ');</script>
    ...
    <div class="wrapper">
        <div class="logo white">
            <a
                target="_self"
                href="../en.html">
                <img src="../contents/4dVXEf6gSg.png"
                     alt=""></a>
            <a
                target="_self"
                href="searchab67.html?title=FRD">
                <img src="../contents/Xuczl0Gp6S.svg"
                     alt=""></a>
            <a
                target="_self"
                href="searchdfa1.html?title=brembo">
                <img src="../contents/pyvI3XbF6c.svg"
                     alt=""></a>
        </div>
        <div class="logo black">
            <a
                target="_self"
                href="../en.html">
                <img src="../contents/mwCf0qfJ80.svg"
                     alt=""></a>
            <a
                target="_self"
                href="searchab67.html?title=FRD">
                <img src="../contents/QQLuesY68Q.svg"
                     alt=""></a>
            <a
                target="_self"
                href="searchdfa1.html?title=brembo">
                <img src="../contents/x1ea8i9Hqc.svg"
                     alt=""></a>
        </div>
        <div class="right-header">
                ...
                <ul>
                    ...
                    <li class="have-child">
                        ...
                        <ul>
                            <li>
                                <a class=""
                                   href="story/faitology.html">
                                    Faitology
                                </a>
                            </li>
                            <li>
                                <a class=""
                                   href="story/faitotech.html">
                                    Faitotech
                                </a>
                            </li>
                            <li>
                                <a class=""
                                   href="story/brembology.html">
                                    Brembology
                                </a>
                            </li>
                            <li>
                                <a class=""
                                   href="story/testimonial.html">
                                    TESTIMONIAL
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="have-child">
                        ...
                        <ul>
                            <li>
                                <a class=""
                                   href="product-faito.html">
                                    Faito Products
                                </a>
                            </li>
                            <li>
                                <a class=""
                                   href="product-brembo.html">
                                    Brembo Products
                                </a>
                            </li>
                        </ul>
            ...
            <div class="box-lang">
                ...
                <span onclick="changeLang('id','1')" class="">ID</span>
            </div>
            <div class="box-search">
                <span class="icon-search"><img src="../images/material/ic-search.png" alt=""></span>
                <span class="icon-search black"><img src="../images/material/ic-search-bl.png" alt=""></span>
...
<div class="popup-search" id="burgermenu">
    ...
    <div class="box-inner-search advance-search">
        <div class="wrap-flex">
            <h3>Advance Search</h3>
            <a href="#" class="btn-arr back white">Back to Home</a>
        </div>
        <div class="form">
            <form action="https://faito.co.id/en/search">
                <div class="row">
                ...
                <div class="row">
                    <div class="col half">
                        <select name="type" id="type">
                            ...
                            <option value="product-faito">Faito Products</option>
                            <option value="product-brembo">Brembo Products</option>
                        </select>
                    </div>
                    <!-- <div class="col half">
                        <select id="">
...
<section class="banner-home">
    <span class="dots-abs"><img src="../images/material/dots-square.png" alt=""></span>
    <div class="slider-home">
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/ZElyCoBksg.png"
                    data-img-medium="../contents/KKpBIdJBF7.png"
                    data-img-small="../contents/Qy72pR5HJ3.png"
                    alt=""></figure>
            <a href="story/faitology.html" class="caption">
                <h2>FAITO <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/LimNETyw8I.jpg"
                    data-img-medium="../contents/AFXc0U7QKY.png"
                    data-img-small="../contents/B2iwwkWKeM.png"
                    alt=""></figure>
        ...
        <div class="list-slider">
            <a href="#" class="caption" target="_blank">
                <h2> <b></b></h2>

            </a>
            <div class="video-home">
                <video autoplay loop control muted>
                    <source src="../contents/oHc33F3oXV.mp4" type="video/mp4">
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/CSTt4TBgMA.jpg"
                    data-img-medium="../contents/0pP6BrZ9kS.png"
                    data-img-small="../contents/3hkYLIKpaH.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/CD5KQaE3px.jpg"
                    data-img-medium="../contents/ViAoHsovY5.png"
                    data-img-small="../contents/9iD7IYIUqM.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/w0NrUBgPi2.jpg"
                    data-img-medium="../contents/kTRnyesTRt.png"
                    data-img-small="../contents/vYaUBZMWyt.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/nVlInSYwtZ.jpg"
                    data-img-medium="../contents/jZwjuX9Rva.jpg"
                    data-img-small="../contents/u1EYELXjUC.jpg"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/IMTNJVuuXP.jpg"
                    data-img-medium="../contents/MnQtt50voM.png"
                    data-img-small="../contents/nc3ifYvcCV.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/jq4WiuhYm9.jpg"
                    data-img-medium="../contents/H5L2eG2ii2.png"
                    data-img-small="../contents/UgAkDZjJIw.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
        ...
        <div class="list-slider">
            <figure><img
                    src="#"
                    data-img-large="../contents/HcAPBYLFZy.png"
                    data-img-medium="../contents/AaxQ9J4hHL.png"
                    data-img-small="../contents/ol1G8WfvZ5.png"
                    alt=""></figure>
            <a href="#" class="caption">
                <h2> <b></b></h2>
    ...
    <div class="medsos-banner">
        <a href="https://www.facebook.com/FaitoRacingID/" rel="nofollow" target="_blank"><img src="../contents/DL94PSMnkG.png" alt=""></a>
        <a href="https://www.tiktok.com/@faitoindonesiaofficial" rel="nofollow" target="_blank"><img src="../contents/G6cXnP7XQs.png" alt=""></a>
        <a href="https://www.instagram.com/faitoindonesia" rel="nofollow" target="_blank"><img src="../contents/8kSM0H9toL.png" alt=""></a>
        <a href="https://www.youtube.com/channel/UCkPIrlLlDTeu5aVX7orJqZQ" rel="nofollow" target="_blank"><img src="../contents/lLW3VdDELH.png" alt=""></a>
    </div>
    <span class="shape-banner"><img src="../images/material/shape-banner.png" alt=""></span>
</section>


<section class="about home">
    <div class="trigger-about"></div>
    <span class="img-abs"><img src="../images/material/shape-about-1.png" alt=""></span>
    <span class="img-abs-2"><img src="../images/material/shape-about-2.png" alt=""></span>
    <div class="wrapper">
        <div class="wrap-flex-home">
            <a href="story/faitology.html" class="img anim-from-bottom" trigger-anim=".trigger-about" delay="0.5">
                <figure>
                    <img src="../contents/ouPkud6jhV.png" alt="">
                </figure>
                <span class="abs-img"><img src="../images/material/shape-img-abs.png" alt=""></span>
            </a>
            <a href="story/faitology.html" class="text anim-from-bottom" trigger-anim=".trigger-about" delay="0.8">
                ...
                <span class="number-big"><img src="../contents/index.html" alt=""></span>
...
<section class="about-2 home">
    ...
    <span class="img-abs"><img src="../images/material/path-about-faito.png" alt=""></span>
    <span class="img-abs-2"><img src="../images/material/dots-about-faito.png" alt=""></span>
    <div class="wrap-flex-home sec-2">
        ...
        <a href="story/faitotech.html" class="img anim-from-bottom" trigger-anim=".trigger-about-2" delay="0.3">
            <figure>
                <img src="../contents/4DMaMQm0mL.png" alt="">
            </figure>
        </a>
    </div>
</section>
...
<section class="product home">
    ...
    <span class="bg"><img src="../contents/tB8tSyuiP2.png" alt=""></span>
    <div class="wrapper">
        ...
        <div class="box-slider-product-home anim-from-bottom" trigger-anim=".trigger-product" delay="0.7">
            <div class="slider-product-home">
                <a href="motor-brand/item/matic.html" class="list">
                    <figure>
                        <img src="../contents/cn62IBPq8M.png" alt="Matic">
                        <figcaption>
                            <h5>Matic</h5>
                        </figcaption>
                    </figure>
                </a>
                <a href="motor-brand/item/matic-premium.html" class="list">
                    <figure>
                        <img src="../contents/t0h5sC0szl.png" alt="Matic Premium">
                        <figcaption>
                            <h5>Matic Premium</h5>
                        </figcaption>
                    </figure>
                </a>
                <a href="motor-brand/item/bebek.html" class="list">
                    <figure>
                        <img src="../contents/hmbrMHErCt.png" alt="Bebek">
                        <figcaption>
                            <h5>Bebek</h5>
                        </figcaption>
                    </figure>
                </a>
                <a href="motor-brand/item/sport.html" class="list">
                    <figure>
                        <img src="../contents/gHEGiOxX60.png" alt="Sport">
                        <figcaption>
                            <h5>Sport</h5>
                        </figcaption>
                    </figure>
                </a>
                <a href="motor-brand/item/cross.html" class="list">
                    <figure>
                        <img src="../contents/jWc0j8Zmf8.png" alt="Cross">
                        <figcaption>
                            <h5>Cross</h5>
                        </figcaption>
                    </figure>
    ...
    <div class="wrapper">
        ...
        <div class="wrap-box-news">
            <a href="news/detail/new-item-arrival-steering-cone-mx-series.html" class="big-img anim-from-bottom" trigger-anim=".trigger-news" delay="0.6">
                <span class="dots-abs"><img src="../images/material/dots-square-small.png" alt=""></span>
                <img src="../contents/enbXNhcBFb.png" alt="">
                <figcaption>
                    <h5>
                        NEW ITEM ARRIVAL! STEERING CONE MX-SERIES
                    </h5>
            ...
            <div class="right-list anim-from-bottom" trigger-anim=".trigger-news" delay="0.8">
                <a href="news/detail/this-is-different-from-the-two-types-of-faito-motor-bearings-that-are-sold-in-the-market.html" class="list">
                    <figure>
                        <img src="../contents/uyynP93oEV.jpg" alt="">
                    </figure>
                    <div class="text">
                        <p>This is different from the two types of Faito motor bearings that are sold in the market</p>
                        <div class="caption-small">
                ...
                <a href="news/detail/petrol-pipe-nbr-pro.html" class="list">
                    <figure>
                        <img src="../contents/lycGDvZIrx.jpg" alt="">
                    </figure>
                    <div class="text">
                        <p>Petrol Pipe NBR Pro</p>
                        <div class="caption-small">
                ...
                <a href="news/detail/new-arrival-pro-stroker-racing-camshaft-for-suzuki-satria-f150.html" class="list">
                    <figure>
                        <img src="../contents/ZmQ6VlAYNi.png" alt="">
                    </figure>
                    <div class="text">
                        <p>New Arrival: Pro Stroker Racing Crankshaft for Suzuki Satria F150</p>
                        <div class="caption-small">
                            <span>Product Review</span>
...
<footer>
    <a target="_blank" href="https://api.whatsapp.com/send?phone=+628111616466" class="live-wa">
        <figure><img src="../images/material/ic-wa.png" alt=""></figure>
        <div class="text">
            <h5>Whatsapp</h5>
            <h3>Live Chat</h3>
        </div>
    ...
    <div class="wrapper">
        <div class="left-foot">
            <div class="box">
                <a href="#" class="logo-foot"><img src="../contents/vVGqW50UMC.svg" alt=""></a>
            </div>
            <div class="box">
        ...
        <div class="right-foot">
            ...
            <div class="quicklink">
                <ul>
                    ...
                    <li>
                        <a class="" href="story/faitology.html">
                            Story
                        </a>

                    </li>
                    <li>
                        <a class="" href="product-faito.html">
                            Product
                        </a>
    ...
    <div class="bottom-foot">
        <p>Copyrights 2021 © PT Faito Racing Development Indonesia.  All Rights Reserved</p>
    </div>
</footer>
<!--end of Footer -->
</body>
